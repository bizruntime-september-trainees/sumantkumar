...
@Component({
  selector: 'app-enableediting',
  templateUrl: './enableediting.component.html',
  styleUrls: ['./enableediting.component.css'],
})
export class EnableeditingComponent implements OnInit {
  public data: Object[] = [];
